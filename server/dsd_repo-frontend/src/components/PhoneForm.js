...
function PhoneForm() {
    // det här hanterar "show / hide" den ögonknappen alltså.
        ...
        <div className="phone-form">
            ...
            <div className="password-input">
                ...
                <button onClick={togglePasswordVisibility} className="toggle-password" type="button">
                    {showPassword ? (
                        // Super long copy & paste länk från w3. Det är bara så vi ska ta de två ögon knapparna, 
                        // en för öppet öga en för stängt öga.
